...
<template>
 <div class="flex flex-col items-center justify-center sm:flex-row gap-y-3 px-4 sm:px-10 fond">
    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 flex flex-col gap-y-3 fond">
      ...
      <!-- II -->
      <div class="w-full flex flex-col gap-y-2 border-4 rounded border-black px-2 py-1 shadow-lg bg-[#AF601A]">
        <h1 class="text-center text-xl font-bold">Ingeniería Industrial</h1>
        <div class="w-full flex flex-col gap-y-1">
          <div class="w-full flex flex-row gap-x-1 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-12 h-12">
    ...
    <div class="m-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 flex flex-col gap-y-3">
      <!-- ISC -->
      <div class="w-full flex flex-col gap-y-2 border-4 rounded border-black px-2 py-1 shadow-lg bg-[#CA6F1E]">
        <h1 class="text-center text-xl font-bold">Ingeniería en Sistemas</h1>
        <div class="w-full flex flex-col gap-y-1">
          <div class="w-full flex flex-row gap-x-1 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-12 h-12">
      ...
      <!-- IEM -->
      <div class="w-full flex flex-col gap-y-2 border-4 rounded border-black px-2 py-1 shadow-lg bg-[#CA6F1E]">
        <h1 class="text-center text-xl font-bold">Ingeniería Electromecánica</h1>
        <div class="w-full flex flex-col gap-y-1">
          <div class="w-full flex flex-row gap-x-1 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-12 h-12">
    ...
    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 pt-10">
      <!-- IER -->
      <div class="w-full flex flex-col gap-y-2 border-4 rounded border-black px-2 py-1 shadow-lg bg-[#A04000]">
        <h1 class="text-center text-xl font-bold">Ingeniería en Energías Renovables</h1>
        <div class="w-full flex flex-col gap-y-1">
          <div class="w-full flex flex-row gap-x-1 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-12 h-12">
